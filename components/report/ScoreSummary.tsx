...
export function ScoreSummary({
  ...
  return (
    <section
      ...
      className="rounded-xl border border-teal-700/30 bg-teal-50/60 p-6 sm:p-8"
    >
      ...
      <p className="mt-2 text-5xl font-semibold text-teal-900">
        {percentageScore}
        <span className="text-2xl font-normal text-neutral-500"> / 100</span>
      </p>

      <p className="mt-4 max-w-prose text-base text-neutral-800">
        {description}
      </p>
    </section>
  );
